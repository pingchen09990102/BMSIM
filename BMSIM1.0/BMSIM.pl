...
GetOptions (
		...
		'bnx|bnx_file:s' => \$bnx,#bnx output
		'Fi|Fragile_file:s' => \$FragileIN,#Fragile Input
		...
		'ChimP|Chimeric_proportion:f' => \$Chi_perc,
		'Bi|Bimera_proportion:f' => \$Chi_Bi,
		'Tri|Trimera_proportion:f' => \$Chi_Tri,
		'Quad|Quadramera_proportion:f' => \$Chi_Qua,
...
=head1 USAGE
 ...
 BMSIM (Version: 1.0.0) is a simulation tool for BioNano molecule data of the BioNano optical mapping platform.
